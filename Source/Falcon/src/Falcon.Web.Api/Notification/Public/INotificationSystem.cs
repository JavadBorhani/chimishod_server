...
namespace Falcon.Web.Api.Notification.Public
{
    ...
    {
        Task<ResponseToken> SendRequest(string[] FriendNotificationIDs ,SClientNotificationData NotificationData , RequestCommonInfo RequestInfo); // intentionally passing this
    }
}
