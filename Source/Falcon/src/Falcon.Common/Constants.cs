...
namespace Falcon.Common
{
    public static class Constants
    {
        ...
        public static class RoutesToIgnoreAuthentication
        {
            ...
            public const string TelegramController = "TelegramController";
        }
...
"</html>";
            ...
            public static string QuestionCreation
            {
                get
                {
                    return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
...
"                                                                    <tr>" +
"                                                                        <td>" +
"                                                                            <a href=\"{{action_url}}\" class=\"button button--green\" target=\"_blank\">What : {1} </a>" +
"                                                                        </td>" +
"                                                                        <td>" +
"                                                                            <a href=\"{{action_url}}\" class=\"button button--green\" target=\"_blank\">But : {2} </a>" +
"                                                                        </td>" +
"                                                                    </tr>" +
"                                                                    <tr>" +
"                                                                        <td>" +
"                                                                            <a href=\"{3}\" class=\"button button--green\" target=\"_blank\">Ban</a>" +
"                                                                        </td>" +
"                                                                        <td>" +
"                                                                            <a href=\"{4}\" class=\"button button--green\" target=\"_blank\">OK</a>" +
"                                                                        </td>" +
"                                                                    </tr>" +
"                                                                </table>" +
"                                                            </td>" +
